...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt->bindParam(':username',$username);$stmt->bindParam(':password',$hashed_password);
        $stmt->bindParam(':role',$role);$stmt->bindParam(':fullname',$fullname);$stmt->bindParam(':email',$email);
        if ($stmt->execute()) { $message = 'success'; }
    } catch (PDOException $e) {
        $message = ($e->getCode() == 23000) ? 'duplicate' : 'error';
    }
}
?>
<!DOCTYPE html>
...
<div class="main">
  <header class="topbar">
    ...
    <span class="topbar-title" data-i18n="reg_user_title">Register User</span>
    <div class="tb-right">
  ...
  <div class="content">
    <div class="card">
      ...
      <?php elseif($message==='duplicate'): ?><div class="alert alert-error"><i class="fas fa-circle-exclamation"></i><span data-i18n="dup_error">Username or Email already exists in the system.</span></div>
